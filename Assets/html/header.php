...
<div id="header">
    <div class="logo-div"><a href="<?php echo SERVER_ROOT_REQUEST ?>"><img src="<?php echo SERVER_ROOT_REQUEST ?>/assets/images/logo.png"></a></div>
...
$id=1;$username="Kafael Ruhn";
        if (is_null($id) || is_null($username)) {
            ...
            ?>
            <div class="dropdown">
                <button class="dropbtn" onclick="location.href='<?php echo SERVER_ROOT_REQUEST ?>'">
                ...
                <h3><a href="<?php echo SERVER_ROOT_REQUEST ?>/pages/user-entry.php">❌ Sair</a>
                </div>
            </div>
        <?php
        }   ?>
